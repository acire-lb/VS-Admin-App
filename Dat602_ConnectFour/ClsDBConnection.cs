...
namespace Dat602_ConnectFour
{
    ...
    {// static so we done need to worry about instantiate it
       ...
       DbProviderFactories.GetFactory(ConnectionStringSettings.ProviderName);
        ...
        private static DataTable GetDataTable(string prSQL, Dictionary<string, Object> prPars, CommandType
       prCommandType)
        // returns the table result of a general query, e.g. "SELECT @val1, @val2 FROM MyTable" as prSQL (if
        // prCommandType = Text)
